...
void main() {
  ...
  group('CustomLintNewsApiClient', () {
    late http.Client httpClient;
    late CustomLintNewsApiClient apiClient;
    ...
    setUp(() {
      ...
      apiClient = CustomLintNewsApiClient(
    ...
    group('localhost constructor', () {
      ...
      test('has correct baseUrl', () async {
        ...
        final apiClient = CustomLintNewsApiClient.localhost(
          httpClient: httpClient,
          tokenProvider: tokenProvider,
        );
    ...
    group('default constructor', () {
      test('can be instantiated (no params).', () {
        expect(
          () => CustomLintNewsApiClient(tokenProvider: tokenProvider),
          returnsNormally,
        );
      });
      ...
      test('has correct baseUrl.', () async {
        ...
        final apiClient = CustomLintNewsApiClient(
          httpClient: httpClient,
          tokenProvider: tokenProvider,
        );
    ...
    group('getArticle', () {
      ...
      test(
          'throws CustomLintNewsApiMalformedResponse '
        ...
        expect(
          ...
          throwsA(isA<CustomLintNewsApiMalformedResponse>()),
        );
      });

      test(
          'throws CustomLintNewsApiRequestFailure '
        ...
        expect(
          () => apiClient.getArticle(id: articleId),
          throwsA(
            isA<CustomLintNewsApiRequestFailure>()
